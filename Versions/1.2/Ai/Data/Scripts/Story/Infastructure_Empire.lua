--/////////////////////////////////////////////////////////////////////////////////////////////////
--AI Imperial Infastructure Plan by Sidious Invader.
--/////////////////////////////////////////////////////////////////////////////////////////////////
...
-- This script will constantly loop, until "ScriptExit()" is used.
	...
	if first_random == 1 then
 		Game_Message("1_RANDOM_1")
 	end	
 	if first_random == 2 then
 		Game_Message("1_RANDOM_2")
 	end	
 	if first_random == 3 then
 		Game_Message("1_RANDOM_3")
 	end	
 	if first_random == 4 then
 		Game_Message("1_RANDOM_4")
 	end	
 	if first_random == 5 then
 		Game_Message("1_RANDOM_5")
 	end	
 	if first_random == 6 then
 		Game_Message("1_RANDOM_6")
 	end	
 	if first_random == 7 then
		Sleep(15)   	
 		Game_Message("1_RANDOM_7")
 	end							
