...
function State_Init(message)
	...
	waypoint1 = Find_First_Object("TASKED8_WAYPOINT1")
	waypoint2 = Find_First_Object("TASKED8_WAYPOINT2")
	waypoint3 = Find_First_Object("TASKED8_WAYPOINT3")
	waypoint4 = Find_First_Object("TASKED8_WAYPOINT4")
	waypoint5 = Find_First_Object("TASKED8_WAYPOINT5")
	tasked1 = Find_All_Objects_With_Hint("tasked8")
