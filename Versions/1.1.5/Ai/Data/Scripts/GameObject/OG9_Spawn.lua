...
function Respawn()
	...
	if not TestValid(last_droid) then
		unit_list = Find_All_Objects_Of_Type("Spawned_Homing_Spider_Droid")
		if table.getn(unit_list) < 8 then 
			Object.Play_SFX_Event("Unit_Ship_Alarm")
			last_droid = Create_Generic_Object("Spawned_Homing_Spider_Droid",Object.Get_Position(),rebel_player)
