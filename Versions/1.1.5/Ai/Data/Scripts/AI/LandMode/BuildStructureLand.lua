...
function Definitions()
	...
	{
		"MainForce"
		,"UC_Power_Generator_R | UC_R_Ground_Base_Shield | UC_R_Small_Ground_Base_Shield | UC_Rebel_Mineral_Processor | UC_Rebel_Ground_Mining_Facility | UC_R_Ground_Turbolaser_Tower | UC_R_Ground_Light_Vehicle_Factory | UC_Ground_Cis_Forward_Command_Post | UC_R_Ground_Heavy_Vehicle_Factory | UC_Ground_Cis_Engineering_Platform | UC_R_Ground_Research_Facility | UC_Communications_Array_R | UC_Ground_Hutt_Palace_R | UC_Ground_Cis_Siege_Mortar | UC_R_Uplink_Station | UC_Ground_Cis_Droid_Center = 0,1"
		,"UC_Power_Generator_E | UC_E_Ground_Base_Shield | UC_Ground_Republic_Merc_Hq | UC_E_Small_Ground_Base_Shield | UC_Empire_Mineral_Processor | UC_Empire_Ground_Mining_Facility | UC_Ground_Republic_Field_Hospital | UC_E_Ground_Turbolaser_Tower | UC_E_Ground_Light_Vehicle_Factory | UC_E_Ground_Heavy_Vehicle_Factory | UC_Ground_Republic_Engineering_Platform | UC_E_Ground_Research_Facility | UC_Communications_Array_E | UC_Ground_Hutt_Palace_E | UC_Ground_Magnepulse_Cannon_E | UC_Ground_Republic_Forward_Command_Post = 0,1"
